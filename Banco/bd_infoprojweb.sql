...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 12-Nov-2018 às 01:05
...
--
CREATE DATABASE IF NOT EXISTS `bd_infoprojweb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `bd_infoprojweb`;
...
CREATE TABLE IF NOT EXISTS `codigolink` (
  `idcodigolink` int(11) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(100) DEFAULT NULL,
  `data` datetime DEFAULT NULL,
  PRIMARY KEY (`idcodigolink`)
...
CREATE TABLE IF NOT EXISTS `discente` (
  ...
  `curso_dicente` varchar(100) NOT NULL,
  `lattes_discente` varchar(100) NOT NULL,
...
INSERT INTO `discente` (`id`, `nome_discente`, `curso_dicente`, `lattes_discente`, `data_inicio`, `data_fim`) VALUES
(1, 'Discente Teste', 'AnÃ¡lise e desenvolvimentos de sistemas', 'https://www.ronaldin.com.br', '2018-11-14', NULL),
(2, 'Getulio Discente', 'AnÃ¡lise e desenvolvimentos de sistemas', 'https://www.ronaldin.com.br', '2018-11-12', NULL),
(3, 'Getulio Discente', 'AnÃ¡lise e desenvolvimentos de sistemas', 'https://www.ronaldin.com.br', '2018-11-12', NULL),
(4, 'Getulio Discente', 'AnÃ¡lise e desenvolvimentos de sistemas', 'https://www.ronaldin.com.br', '2018-11-12', NULL),
(5, 'Getulio Discente', 'AnÃ¡lise e desenvolvimentos de sistemas', 'https://www.ronaldin.com.br', '2018-11-12', NULL),
(6, 'Mikael Discente', 'ADS', 'https://web.whatsapp.com/', '2018-11-12', NULL);
...
CREATE TABLE IF NOT EXISTS `docentes` (
  ...
  `lattes_docente` varchar(100) NOT NULL,
...
INSERT INTO `docentes` (`id`, `nome_docentes`, `img`, `data_inicio`, `data_termino`, `lattes_docente`, `curso`) VALUES
(1, 'fulano', 'ee03b66713b30c7245a7d2ed32cf0e6a.jpg', NULL, NULL, '', 'ADS'),
(2, 'Getulio Docente', 'aa148f9e3c9faebdc476741f58b05350jpeg', NULL, NULL, 'https://www.ronaldo.com', 'AnÃ¡lise e desenvolvimentos de sistemas');
...
INSERT INTO `equipamentos` (`id`, `nome_equipamento`, `descricao`, `data_inicio`, `data_remocao`) VALUES
(1, 'Urna Eletronica', 'utilizada em eleicoes', '2018-11-12', NULL),
(2, 'Computador Desktop i5', 'Utilizado para pesquisas', '2018-11-12', NULL);
...
CREATE TABLE IF NOT EXISTS `grupopesquisa` (
  ...
  `linhapesquisa_id` int(11) NOT NULL DEFAULT '0',
  `tecnico_id` int(11) DEFAULT NULL,
  `equipamento_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`,`lider_id`,`situacao_id`,`linhapesquisa_id`),
  KEY `fk_grupopesquisa_usuario1_idx` (`lider_id`),
  KEY `fk_grupopesquisa_situacao1_idx` (`situacao_id`),
  KEY `fk_grupopesquisa_linhapesquisa1_idx` (`linhapesquisa_id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `grupopesquisa`
--

INSERT INTO `grupopesquisa` (`id`, `nome_grupo`, `sigla_grupo`, `link_lattes`, `email`, `texto`, `data_criacao`, `lider_id`, `situacao_id`, `img`, `linhapesquisa_id`, `tecnico_id`, `equipamento_id`) VALUES
(4, 'GRUPO PESQUISA TL', 'GPTL', '', 'teste@teste.com', 'alguma coisa', '2018-11-10', 11, 1, NULL, 0, NULL, NULL),
(5, 'GRUPO PESQUISA', 'GP', '', 'teste@teste.com', 'alguma coisa', '2018-11-10', 12, 1, NULL, 0, NULL, NULL),
(6, 'SEM LIMITE', 'SM', '', 'teste@teste.com', 'TESTE', '2018-11-10', 12, 1, NULL, 0, NULL, NULL);

-- --------------------------------------------------------

--
-- Estrutura da tabela `grupopesquisa_docentes`
--

DROP TABLE IF EXISTS `grupopesquisa_docentes`;
CREATE TABLE IF NOT EXISTS `grupopesquisa_docentes` (
  `grupopesquisa_id` int(11) NOT NULL,
  `grupopesquisa_linhapesquisa_id` int(11) NOT NULL,
  `docentes_id` int(11) NOT NULL,
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`grupopesquisa_id`,`grupopesquisa_linhapesquisa_id`,`docentes_id`,`id`),
  KEY `fk_grupopesquisa_has_docentes_docentes1_idx` (`docentes_id`),
  KEY `fk_grupopesquisa_has_docentes_grupopesquisa1_idx` (`grupopesquisa_id`,`grupopesquisa_linhapesquisa_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `grupopesquisa_docentes`
--

INSERT INTO `grupopesquisa_docentes` (`grupopesquisa_id`, `grupopesquisa_linhapesquisa_id`, `docentes_id`, `id`) VALUES
(5, 2040200, 1, 10),
(6, 2040200, 1, 1);
...
--
-- Estrutura da tabela `linhapesquisa`
--
...
--
-- Extraindo dados da tabela `linhapesquisa`
--

INSERT INTO `linhapesquisa` (`cod_linha`, `nome_linha`) VALUES
...
(10501029, 'FÍSICA CLÁSSICA E FÍSICA QUÂNTICA MECÂNICA E CAMPO'),
(10501037, 'RELATIVIDADE E GRAVITAÇÃO'),
(10501045, 'FÍSICA ESTATÍSTICA E TERMODINÂMICA'),
(10501053, 'METROLOGIA -  TECN. GER. DE LAB. E SIST. DE INSTRU'),
(10501061, 'INSTRUMENTAÇÃO ESPECÍFICA DE USO GERAL EM FÍSICA'),
(10502009, 'ÁREAS CLÁSSICAS DE FENOMENOLOGIA E SUAS APLICAÇÕES'),
(10502017, 'ELETRICIDADE E MAGNETISMO CAMPOS E PARTÍCULAS CARR'),
(10502025, 'ÓTICA'),
(10502033, 'ACÚSTICA'),
(10502041, 'TRANSFERÊNCIA DE CALOR - PROCESSOS TÉRMICOS E TERM'),
...
(10503021, 'TEOR.ESP.E MOD.DE INTERAÇÃO - SIST.DE PARTÍCULAS -'),
(10503030, 'REAÇÕES ESPECÍFICAS E FENOMIOLOGIA DE PARTÍCULAS'),
(10503048, 'PROPRIEDADES DE PARTÍCULAS ESPECÍFICAS E RESSONÂNC'),
...
(10504044, 'REAÇÕES NUCLEARES E ESPALHAMENTO (REAÇÕES ESPECÍFI'),
(10504052, 'PROPRIEDADES DE NÚCLEOS ESPECÍFICOS'),
(10504060, 'MET.EXPER.E INSTRUMENT.PARA PART.ELEMENT.E FÍSICA '),
(10505008, 'FÍSICA ATÔMICA E MOLECULAR'),
(10505016, 'ESTRUTURA ELETRÔNICA DE ÁTOMOS E MOLÉCULAS - TEORI'),
(10505024, 'ESPECTROS ATÔMICOS E INTEGRAÇÃO DE FÓTONS'),
(10505032, 'ESPECTROS MOLECUL. E INTERAÇÕES DE FÓTONS COM MOLÉ'),
(10505040, 'PROCESSOS DE COLISÃO E INTERAÇÕES DE ÁTOMOS E MOLÉ'),
(10505059, 'INF.SOB.ATOM.E MOL.OBIT.EXPERIMENTALMENTE - INST.E'),
(10505067, 'ESTUDOS DE ÁTOMOS E MOLÉCULAS ESPECIAIS'),
(10506004, 'FÍSICA DOS FLÚIDOS - FÍSICA DE PLASMAS E DESCARGAS'),
(10506012, 'CINÉTICA E TEOR.DE TRANSP.DE FLÚIDOS - PROPRIED.FI'),
...
(10507027, 'PROPRIEDADES MECÂNICAS E ACÚSTICAS DA MATÉRIA COND'),
(10507035, 'DINÂMICA DA REDE E ESTATÍSTICA DE CRISTAIS'),
(10507043, 'EQUAÇÃO DE ESTADO - EQUILIB. DE FASES E TRANSIÇÕES'),
(10507051, 'PROPRIEDADES TÉRMICAS DA MATÉRIA CONDENSADA'),
(10507060, 'PROPRIEDADES DE TRANSP.DE MATÉRIA COND. (NÃO ELETR'),
...
(10507108, 'TRANSP.ELETR.E PROPR.ELET.DE SUPERFÍCIES - INTERF.'),
(10507116, 'ESTRUT.ELETR.E PROPR.ELET.DE SUPERFÍCIES - INTERF.'),
(10507124, 'SUPERCONDUTIVIDADE'),
(10507132, 'MATERIAIS MAGNÉTICOS E PROPRIEDADES MAGNÉTICAS'),
(10507140, 'RESS.MAGN. REL.MAT.COND. - EFEIT.MOSBAUER - CORR.A'),
(10507159, 'MATERIAIS DIELÉTRICOS E PROPRIEDADES DIELÉTRICAS'),
(10507167, 'PROP.OTIC.E ESPEC.MATR.COND. - OUTRAS INTER.MAT.CO'),
(10507175, 'EMISSÃO ELETRON.E IÔNICA POR LIQ.E SÓLIDOS - FENOM'),
(10600000, 'QUÍMICA'),
...
(10602046, 'DETERMINAÇÃO DE ESTRUTURAS DE COMPOSTOS INORGÂNICO'),
...
(10801014, 'INTER.ENTRE OS ORGAN.MARINHOS E OS PARÂMETROS AMBI'),
...
(10803025, 'INTER.QUÍM.-BIOL./GEOL.DAS SUBST. QUIM.DA ÁGUA DO '),
...
(30203015, 'MÉTODOS DE CONCENTRAÇÃO E ENRIQUECIMENTOS DE MINÉR'),
...
(30401046, 'MATERIAIS DIELÉTRICOS, PIESOELÉTRICOS E FERROELÉTR'),
(30401054, 'MAT. E COMP. ELETROÓTICOS E MAGNET., MAT. FOTOELÉT'),
(30401062, 'MATERIAIS E DISPOSITIVOS MAGNÉTICOS'),
(30402000, 'MEDIDAS ELÉTRICAS, MAGNÉTICAS E ELETRÔNICAS - INST'),
...
(30404029, 'TRANSMISSÃO DA ENERGIA ELET., DISTRIB. DA ENERGIA '),
(30404037, 'CONVERSÃO E RETIFICAÇÃO DA ENERGIA ELÉTRICA'),
(30404045, 'MEDIÇÃO, CONTROLE, CORREÇÃO E PROTEÇÃO DE SIST. EL'),
(30404053, 'MÁQUINAS ELÉTRICAS E DISPOSITIVOS DE POTÊNCIA'),
(30404061, 'INSTALAÇÕES ELÉTRICAS PREDIAIS E INDUSTRIAIS'),
(30405009, 'ELETRÔNICA INDUSTRIAL, SISTEMAS E CONTROLES ELETRÔ'),
(30405017, 'ELETRÔNICA INDUSTRIAL'),
(30405025, 'AUTOMAÇÃO ELETRÔNICA DE PROCESSOS ELÉTRICOS E INDU'),
(30405033, 'CONTROLE DE PROCESSOS ELETRÔNICOS, RETROALIMENTAÇÃ'),
(30406005, 'TELECOMUNICAÇÕES'),
(30406013, 'TEORIA ELETROMAG., MICROONDAS, PROPAGAÇÃO DE ONDAS'),
...
(30504066, 'MÉTODOS DE SÍNTESE E OTIMIZAÇÃO APLICADOS AO PROJ.'),
...
(30602009, 'OPERAÇÕES INDUSTRIAIS E EQUIPAMENTOS PARA ENG. QUÍ'),
...
(30801028, 'PLANEJAMENTO,PROJETO E CONTROLE DE SIST. DE PRODUÇ'),
...
(30903025, 'CONVERSÃO,ENRIQUECIMENTO E FABRICAÇÃO DE COMBUST. '),
...
(30904048, 'GERAÇÃO E INTEGRAÇÃO COM SISTEMAS ELÉTRICOS EM REA'),
(30904056, 'INSTRUMENTAÇÃO PARA OPERAÇÃO E CONTROLE DE REATORE'),
...
(31001017, 'PLANEJAMENTO E ORGANIZAÇÃO DO SISTEMA DE TRANSPORT'),
...
(31105009, 'TECNOLOGIA DE CONSTRUÇÃO NAVAL E DE SISTEMAS OCEÂN'),
(31105017, 'MÉTODOS DE FABRICAÇÃO DE NAVIOS E SISTEMAS OCEÂNIC'),
...
(31201024, 'AERODINÂMICA DOS PROCESSOS GEOFÍSICOS E INTERPLANE'),
...
(31204007, 'MATERIAIS E PROCESSOS P/ENGENHARIA AERON. E AEROES'),
...
(31206069, 'NORMATIZAÇÃO E CERT. DE QUAL. DE AERONAVES E COMPO'),
...
(50601040, 'MANEJO E CONSERVAÇÃO DE RECURSOS PESQUEIROS MARINH'),
(50602004, 'RECURSOS PESQUEIROS DE ÁGUAS INTERIORES'),
(50602012, 'FATORES ABIÓTICOS DE ÁGUAS INTERIORES'),
(50602020, 'AVALIAÇÃO DE ESTOQUES PESQUEIROS DE ÁGUAS INTERIOR'),
(50602039, 'EXPLORAÇÃO PESQUEIRA DE ÁGUAS INTERIORES'),
(50602047, 'MANEJO E CONSERV. DE RECURSOS PESQUEIROS DE ÁGUAS '),
...
(50701029, 'QUÍMICA,FÍSICA,FÍSICO-QUÍM. BIOQ. DOS ALI. MAT. PR'),
...
(60302011, 'MÉTODOS E MODELOS MATEMÁT., ECONOMÉTRICOS E ESTATÍ'),
...
(60305029, 'RELAÇÕES DO COMÉRCIO - POLÍT. COMERCIAL - INTEGRAÇ'),
...
(60306017, 'TREIN. E ALOCAÇÃO DE MÃO-DE-OBRA, OFERTA MÃO-DE-OB'),
(60306025, 'MERCADO DE TRABALHO - POLÍTICA DO GOVERNO'),
(60306033, 'SINDICATOS,DISSÍDIOS COLET.,RELAÇÕES DE EMPREGO(EM'),
...
(60404027, 'CONCEITUAÇÃO DE PAISAGISMO E METODOLOGIA DO PAISAG'),
...
(60502002, 'MÉTODOS E TÉCNICAS DO PLANEJAMENTO URBANO E REGION'),
...
(60502045, 'TÉCNICAS DE PLANEJAMENTO E PROJETO URBANOS E REGIO'),
...
(60503041, 'ASPECTOS ECONÔMICOS DO PLANEJAMENTO URBANO E REGIO'),
(60503050, 'ASPECTOS FÍSICO-AMBIENTAIS DO PLANEJ. URBANO E REG'),
...
(60902043, 'JORNALISMO ESPECIALIZADO (COMUNITÁRIO, RURAL,EMP. '),
...
(70701024, 'METODOLOGIA,INSTRUMENTAÇÃO E EQUIPAMENTO EM PSICOL'),
(70701032, 'CONSTRUÇÃO E VALIDADE DE TESTES, ESC. E O. MEDIDAS'),
(70701040, 'TÉCN. DE PROCES. ESTÁT., MATEMÁTICO E COMPUT. EM P'),
...
(70704023, 'MECANISMOS INSTINTIVOS E PROCESSOS SOCIAIS EM ANIM'),
...
(70707014, 'PROCESSOS PERCEPTUAIS E COGNITIVOS - DESENVOLVIMEN'),
...
(70803030, 'AVAL. DE SISTEMAS, INST. PLANOS  E PROGRAMAS EDUCA'),
...
(70805024, 'CURRÍCULOS ESPECÍFICOS PARA NÍVEIS E TIPOS DE EDUC'),
...
(70905045, 'RELAÇÕES INTERNACIONAIS, BILATERAIS E MULTILATERAI'),
(71000003, 'TEOLOGIA'),
...
--
-- Estrutura da tabela `projetopesquisa`
--

DROP TABLE IF EXISTS `projetopesquisa`;
CREATE TABLE IF NOT EXISTS `projetopesquisa` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_orientador` int(11) DEFAULT NULL,
  `grupopesquisa_id` int(11) NOT NULL,
  `docentes_id` int(11) NOT NULL,
  `tipobolsa_id` int(11) NOT NULL,
  `dicente_id` int(11) NOT NULL,
  `nome_projeto` varchar(200) NOT NULL,
  PRIMARY KEY (`id`,`grupopesquisa_id`,`docentes_id`,`tipobolsa_id`,`dicente_id`),
  KEY `fk_projetopesquisa_grupopesquisa1_idx` (`grupopesquisa_id`),
  KEY `fk_projetopesquisa_docentes1_idx` (`docentes_id`),
  KEY `fk_projetopesquisa_tipobolsa1_idx` (`tipobolsa_id`),
  KEY `fk_projetopesquisa_dicente1_idx` (`dicente_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `projetopesquisa`
--

INSERT INTO `projetopesquisa` (`id`, `id_orientador`, `grupopesquisa_id`, `docentes_id`, `tipobolsa_id`, `dicente_id`, `nome_projeto`) VALUES
(6, 2, 6, 2, 3, 6, '  Uma Nova Historia');
...
CREATE TABLE IF NOT EXISTS `publicacao` (
  ...
  `grupopesquisa_docentes_docentes_id` int(11) NOT NULL,
  `grupopesquisa_docentes_id` int(11) NOT NULL,
  `projetopesquisa_id` int(11) NOT NULL,
  `publicacao` text NOT NULL,
  `linhapesquisa_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`,`grupopesquisa_docentes_docentes_id`,`grupopesquisa_docentes_id`,`projetopesquisa_id`),
  KEY `fk_publicacao_grupopesquisa_docentes1_idx` (`grupopesquisa_docentes_docentes_id`,`grupopesquisa_docentes_id`),
  KEY `fk_publicacao_projetopesquisa1_idx` (`projetopesquisa_id`)
...
INSERT INTO `publicacao` (`id`, `titulo`, `tipo`, `data`, `referencia`, `grupopesquisa_docentes_docentes_id`, `grupopesquisa_docentes_id`, `projetopesquisa_id`, `publicacao`, `linhapesquisa_id`) VALUES
(5, 'Titulo 1', '2', NULL, 'abnt', 1, 1, 1, 'PUBLICACAO AQUI', NULL),
(6, 'Titulo 1', '2', NULL, 'abnt', 1, 1, 2, 'controle de pragas', NULL),
(7, 'Publicacao sobre o campo', '3', NULL, 'abnt', 1, 1, 2, ' oi\r\n                      ', 2040200),
(13, 'Publicacao sobre o campo222', '3', NULL, 'abnt', 1, 1, 2, 'roses are red\r\nvioletes are blue\r\nunexpected \"{\"\r\non line 32', 2040200),
(14, 'publicacao sem grupo', '2', NULL, 'abnt', 1, 2, 1, 'TESTE', NULL);
...
CREATE TABLE IF NOT EXISTS `tecnico` (
  ...
  `lattes_tecnico` varchar(100) NOT NULL,
...
INSERT INTO `tecnico` (`id`, `nome_tecnico`, `lattes_tecnico`, `atividade`, `formacao`, `ano_conclusao`, `data_inicio`, `data_fim`, `img`) VALUES
(1, '  Mikael Tecnico', '', 'manutenÃ§Ã£o de computadores', 'formacaoTecnico', '2018-11-10', '0000-00-00', '0000-00-00', '9561b6674a38ec604a0118673f3b43a6.jpg'),
(2, 'Getulio Tecnico', 'https://www.youtube.com/', 'Manutencao preventiva', 'formacaoTecnico', '2018-11-12', NULL, NULL, 'a180dfbd0f90c7c04979ad9721a5be05jpeg');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tipobolsa`
--

DROP TABLE IF EXISTS `tipobolsa`;
CREATE TABLE IF NOT EXISTS `tipobolsa` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome_bolsa` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tipobolsa`
--

INSERT INTO `tipobolsa` (`id`, `nome_bolsa`) VALUES
(1, 'Voluntario'),
(2, 'CNPQ'),
(3, 'PIBIFSP'),
(4, 'Outros');
...
INSERT INTO `usuario` (`id`, `nome`, `email`, `senha`, `senha_nova`, `data_senha`, `prontuario`, `lattes`, `permissao_id`, `img`) VALUES
(11, 'Mikael Administrador', 'mikael.souza6@gmail.com', '123', NULL, NULL, '1690256', '', 1, '7841e5b5eb8699c010ffa7e8ffac1e90.jpg'),
(12, 'Mikael Lider', 'mikael.souza6@gmail.com', '123', NULL, NULL, '123', '', 2, '9695a630b52b64097b05315ce5d741a0');
COMMIT;
