    ...
    $diretorio = "arquivoIMG/";
        ...
        if($_FILES['img']['name'] == ""){
             ...
             $pdo=$sql->query("UPDATE grupopesquisa SET nome_grupo ='$nome' , lider_id ='$lider', sigla_grupo = '$sigla', link_lattes='$link', texto = '$texto' ,email ='$email', situacao_id = '1'  WHERE id ='$id'");
              ...
              header("Location: grupo_pesquisa_lider.php");
...
<body>
    ...
    <p style="font-size:200%; text-align:center;color: rgb(0, 0, 0);"><strong>Editar Grupo de Pesquisa</strong></p>
						<hr>
                                    ...
                                    <form method="post" role="form"  action="editar_lider.php?id=<?php echo $id;?>" style="display: block;" enctype="multipart/form-data">
...
if($pdo->rowCount()>0){
   ...
   $nome_= $dado['nome_grupo'];
                                       ...
                                       ?>
                                           ...
                                           Nome do Grupo:
                                            <input type="text" name="nome" tabindex="1" class="form-control" placeholder="Nome" value="<?php echo $nome_  ?>"><br>
