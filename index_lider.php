...
if ($nome == "" ) {
  header ("Location: complete_cadastro_lider.php?id=$id") ; 
}
...
// CRIA UM ARRAY E O EXIBE.
    ...
    //echo " {$linha['nomeGrupo']} -  {$linha['sigla_grupo']}<br /> <br /> <br /> ";
        ...
        ?>
          ...
          $ide = $linha['id'];
         echo " {$linha['nome_grupo']} -  {$linha['sigla_grupo']}<br/>" ?> <a href="espelho_grupo.php?id=<?php echo $linha['id']?> "  target = "_black">Ver Mais</a>
