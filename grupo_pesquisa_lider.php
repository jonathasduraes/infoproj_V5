 ...
 <div class="container">
  ...
  <div class="table-responsive">
    <table class="table table-striped table-bordered table-hover">
     ...
     $pdo= $sql->query("SELECT grupopesquisa.id ,grupopesquisa.nome_grupo, usuario.nome,grupopesquisa.sigla_grupo, grupopesquisa.link_lattes, grupopesquisa.email,grupopesquisa.data_criacao, usuario.permissao_id FROM grupopesquisa inner JOIN  usuario on grupopesquisa.lider_id = usuario.id");
